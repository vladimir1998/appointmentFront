...
export const MOCK_SERVICES: Service[] = [
  ...
  },
  {
    ...
    priceMax: 6000,
    priceType: 'range',
    priceComment: 'Depends on the amount of work and presence of tartar buildup',
    duration: 45,
    durationMax: 60,
    organizationId: 'mock',
    about: [
  ...
  },
  {
    ...
    price: 3500,
    priceType: 'from',
    priceComment: 'Price increases with premium oils or extended session selected',
    duration: 60,
    durationMax: 90,
    organizationId: 'mock',
    about: [
  ...
  },
  {
    ...
    priceComment: 'Exact cost is confirmed after pre-registration',
    duration: 40,
    durationMax: 60,
    organizationId: 'mock',
    about: [
